...
@Log4j2
public class AddCocktailCommand implements Command, UserCommand {
    ...
    public CommandResult execute(RequestContext requestContext) {
        ...
        Validator validator = new ImgFileValidator(img, new CocktailNameValidator(name, new CompositionValidator(composition)));
        ...
        if (serverMessage.isEmpty()) {
            ...
            commandResult = new CommandResult(Map.of(RequestAttribute.SERVER_MESSAGE,
                    LocalizationMessage.localize(requestContext.getLocale(), serverMessage.get()),
                    RequestAttribute.REDIRECT_COMMAND, CommandType.ADD_COCKTAIL.getCommandName()),
                    new HashMap<>());
        }
