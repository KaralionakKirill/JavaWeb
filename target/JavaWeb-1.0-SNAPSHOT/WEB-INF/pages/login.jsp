...
<!DOCTYPE html>
<c:set var="page" value="/WEB-INF/pages/login.jsp" scope="request"/>
        ...
        <div class="panel-body" style="width:18rem">
            <form action="<c:url value="/controller"/>" method="post" class="needs-validation" novalidate>
                ...
                <button type="submit" class="btn btn-primary" name="command" value="login"
                        style="margin: 1rem"><fmt:message key="login"/></button>
                <a href="<c:url value="/controller?command=registration"/>"><fmt:message key="registration"/></a>
            </form>
        </div>
    </div>
</div>
